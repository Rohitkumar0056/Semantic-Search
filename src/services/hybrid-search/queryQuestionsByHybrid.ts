...
import { hybridSearchFromText } from "./hybridSearchService";
import { LoggerService } from "../loggerService";

export async function queryQuestionsByHybrid(
  query_text: string,
  bot_id: string,
  limit: number,
  ...
  try {
    ...
    logger?.add_step(
      "queryQuestionsByHybrid: Merged query results",
